...
import { pollitos, monstruitos, heladitos, neutro, test } from "./variablesS.js";
...
const options_object = (current, url) => {
  return {
    ...
    logoWidth: 450, // fixed logo width. default is `width/3.5`
    logoHeight: 450, // fixed logo height. default is `heigth/3.5`
    ...
    // ====== Title
    title: "_", // content
    titleFont: "normal normal bold 10px Urbanist", //font. default is "bold 16px Arial"
    titleColor: current.titleColor, // color. default is "#000"
    titleBackgroundColor: "white", // background color. default is "#fff"
    titleHeight: 120, // height, including subTitle. default is 0 (que tan pegado queda el titulo del qr. Entre mas peque mas despegado y entre mas grande mas pegado dah!)
    titleTop: 30, // draws y coordinates. default is 30 (Entre mas pequeño mas arriba queda el titulo)

    // ====== SubTitle
    subTitle: "Ayuda, estoy perdido", // content
    subTitleFont: "normal normal normal 100px Urbanist", // font. default is "14px Arial"
    subTitleColor: current.subTitleColor, // color. default is "4F4F4F"
    subTitleTop: 85, // draws y coordinates. default is 0 (que tan pegado queda el sub titulo del qr. Entre mas peque mas despegado)
